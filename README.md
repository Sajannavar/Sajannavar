...
A password and secrets management platform that I'm building as a personal project.

The project covers authentication, secrets management, APIs, PostgreSQL, Redis and production deployment.

**Stack:** Node.js, PostgreSQL, Redis, Nginx, PM2, AWS

### Stocks Workova

A self-hosted stock market analysis platform that I'm building for personal use.

It focuses on market data, historical prices, technical analysis, trading strategies and portfolio research.
...
**Systems:** Linux, Bash, Nginx, HAProxy

**Databases:** Oracle, PostgreSQL, MariaDB, Redis
